...
| Odontolaveglia · Clínica Odontológica (@odontolaveglia) · Nueva Barcelona, Anzoátegui | `odontolaveglia` | **Base OSCURA** navy: `#081722`/`#0A1B26` fondo · superficies `#122A3B`/`#1F2F3E` · **azul cielo de marca `#79B5D9`** (acento/CTA, muestreado PIL del feed) + glow `#A7D3EC` · tinta `#F5F8FC` · **acento cálido coral `#F2A98C`** (calidez humana: sección "El trato", glow del hero, botón de cuidado — navy+coral clásico de salud, añadido por psicología del rubro) · amarillo Cashea `#FBF940` **solo** como badge partner (la marca ya vive en blanco-sobre-navy → admite oscura) | **Epilogue** (display/UI 300–800) + **Space Mono** (eyebrows/HUD/datos) · densidad media-técnica clínica · base oscura | **Interfaz de escáner clínico / "estudios" numerados EST.01–06** — no bandas apiladas, no bento | **Canvas de nube de puntos "escaneo intraoral 3D"**: arcada dental (U) que se revela bajo un haz de escaneo que barre, con HUD "VISTA INTRAORAL · MAXILAR" y % en vivo (calco de su Shining 3D real) + **`@property` aura cónica** girando tras el visor + **tilt 3D** de la foto del escáner | **Barra de estado con píldora "Abierto ahora" EN VIVO** (calculada de su horario real: verde abierto / ámbar emergencias / cerrado-abre) / **Footer = panel de horario semanal** con día actual resaltado en vivo + emergencias en amarillo | Tarjetas "estudio" con **corchetes de retícula de escáner** (esquinas [ ]) + código mono EST.0X, hairlines · CTA principal = **rectángulo sky con underglow** · secundario = ghost hairline · constructor **"Arma tu cita"** (chips servicio+día+Cashea → ficha de cita → `wa.me` pre-armado) · FAB WhatsApp | 2026-07-27 | demo construida — **mensaje NO enviado** (Edith revisa) |
...
- Contador de bases tras esta: …Mary · LB · Calantha (claras) · **Odontolaveglia (OSCURA)** → la próxima **puede volver a clara**.
