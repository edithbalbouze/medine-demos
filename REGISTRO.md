...
| Amazonas Pole Academy | `amazonas-pole-academy` | _(reconstruir)_ | Archivo Black + Jost + Yellowtail (3 familias) | Bandas apiladas (`hero band` + `band`) | _(sin firma registrada)_ | _(reconstruir)_ | _(reconstruir)_ | _(retroactivo)_ | _(revisar)_ |
